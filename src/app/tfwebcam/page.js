"use client";
import App from "./../../scriptsTfWebcam/App";
    ...
    <Fragment>
      ...
      {/* Video being played in the background */}
        {/* <video id="canvasVideo" className="video"  autoPlay muted loop> 
          ...
          <video id="canvasVideo" autoplay></video>

      {/* Webcam for getiin the xy-cordinates of 17 key body points */}
      <canvas 
      
        style={{  width: "100vw" , height : "100vh", position: "absolute", top : 0 , zIndex : "-20"}} 
        id={"canvasToLoad"}>
        </canvas>

        <img style={{ visibility: "hidden",width: "100vw" , height : "100vh", position: "absolute", top : 0}} id="imageParticles" />
